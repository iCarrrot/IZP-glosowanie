...
urlpatterns = [
    ...
    url(r'^(?P<poll_id>[0-9]+)/$', views.poll_detail, name='poll'),
    url(r'^(?P<poll_id>[0-9]+)/poll_detail/$',
        views.poll_detail, name='poll_detail'),
    url(r'^([0-9]+)/(?P<question_id>[0-9]+)/$',
        views.question_detail, name='question'),
    url(r'^([0-9]+)/(?P<question_id>[0-9]+)/question_detail/$',
