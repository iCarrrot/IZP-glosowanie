...
def employers_iterator():
    employers = [
        ...
        "mgr Adrian Łańcucki",
        "mgr Jan Marcinkowski",
        "mgr Krzysztof Nowicki",
        "mgr Piotr Ostropolski-Nalewaja",
        "mgr Maciej Pacut",
        "mgr Krzysztof Piecuch",
        "mgr Piotr Polesiuk",
        "mgr Michał Różański",
        "mgr Paweł Schmidt",
        "mgr Krzysztof Sornat",
        "mgr Paweł Wieczorek",
        "mgr Michał Zapotoczny",
        "dr hab. Anna Bartkowiak",
        "prof. Stanisław Lewanowicz",
        "prof. Maciej M. Sysło",
        "dr Adam Szustalewicz",
        "inż. Wojciech Leśniewski",
        "Janusz Marciniak",
        "inż. Marcin Motykiewicz",
        "Stanisław Przytocki",
        "mgr inż. Beata Rusiecka",
        "inż. Anna Smolińska",
        "mgr Aleksandra Stachowiak",
        "Magdalena Szymańska",
        ...
        "prof. dr hab. Ryszard Szwarc",
        "dr Krzysztof Tabisz",
        "dr hab. Krzysztof Topolski",
        "dr hab. Roman Urban",
        "dr hab. Roman Wencel",
        "dr inż. Łukasz Wojakowski",
        "dr Błażej Wróbel",
